 ...
 * @last updated: 20250710; from 20241217
...
public class UsbongMain {
  ...
  private static int iScreenHeight;
    ...
    private static void createAndShowGUI() {
		...
		//added by Mike, 20250710
		//Reference: https://stackoverflow.com/questions/6322627/java-toolkit-getting-second-screen-size; last accessed: 20250710
		//answer by Alpha2k, 20150703T1859
		...
		for (int i = 0; i < gs.length; i++) {
			...
			int iNewScreenWidth = gs[i].getDisplayMode().getWidth();
			int iNewScreenHeight = gs[i].getDisplayMode().getHeight();
		
			//added by Mike, 20250710
			//get the larger
			if (iScreenWidth<iNewScreenWidth) {
				iScreenWidth=iNewScreenWidth;
			}
			if (iScreenHeight<iNewScreenHeight) {
				iScreenHeight=iNewScreenHeight;
			}
